    ...
    <footer className="mt-14 flex items-end justify-between px-5 py-4 sm:flex text-body-4 md:text-body-3">
      <div className="flex flex-col md:flex-row md:w-[62.5vw] lg:w-[57.5vw] justify-between">
        <div className="flex space-x-1" >
          <span>&copy;</span>
          <span>2023/2024</span>
          <span className="font-extrabold uppercase 2xl:text-body-1">Von | forked from Hyung.</span>
        </div>
        <div>
          <span className=" text-body-4 2xl:text-body-1">Site desenhado e programado com 🍵</span>
        </div>
      </div>
      <button onClick={toTop} className="col-span-2 flex items-center space-x-2 w-fit group 2xl:text-body-1">
        <span className="font-extrabold uppercase hover:font-black duration-200">DEVOLTA AO TOPO</span>
